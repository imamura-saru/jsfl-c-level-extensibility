...
#define JS_DefineFunction(n, c, a) \
    (mmEnv.defineFunction ? (*(mmEnv.defineFunction))(mmEnv.libObj, n, c, a) : JS_FALSE)
...
/* JSBool JS_ExecuteScript(JSContext *cx, JSObject *obj, *unsigned short *script, unsigned int sz, jsval *rval) */
